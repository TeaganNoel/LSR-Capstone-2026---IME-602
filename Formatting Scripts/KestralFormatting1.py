...
def form_entry():
    ...
    # Labels + Entries
    tk.Label(root, text="testID").grid(row=0, column=0, padx=5, pady=5)
    entry_testid = tk.Entry(root)
    entry_testid.grid(row=0, column=1, padx=5, pady=5)

    tk.Label(root, text="deviceID").grid(row=1, column=0, padx=5, pady=5)
    entry_deviceid = tk.Entry(root)
    entry_deviceid.grid(row=1, column=1, padx=5, pady=5)

    tk.Label(root, text="samplingrate").grid(row=2, column=0, padx=5, pady=5)
    ...
    tk.Button(root, text="Quit", command=quit_app).grid(row=3, column=1, pady=10)
...
#testID, deviceID, samplingrate = form_entry()
result = form_entry()
print("result:",result)
if result:
