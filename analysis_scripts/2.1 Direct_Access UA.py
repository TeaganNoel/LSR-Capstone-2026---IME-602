"""
LSR Unified Run Viewer — Version 1 (Direct Access for Mason)
This script connects to the local MySQL database on Mason's laptop.
It loads AiM, DataQ, and Kestrel data, merges them, computes derived
channels, calculates performance metrics, and visualizes the run.
"""
...
# ------------------------------------------------------------
# DIRECT LOCAL CONNECTION (MASON'S MACHINE ONLY)
# ------------------------------------------------------------
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LSR Unified Run Viewer — Direct Access")
